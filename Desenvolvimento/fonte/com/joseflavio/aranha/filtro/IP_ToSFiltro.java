...
import com.joseflavio.aranha.ToS;

/**
 * @author José Flávio de Souza Dias Júnior
 * @version 2011
 */
public class IP_ToSFiltro implements Filtro {

	private ToS alvo;
	
	public IP_ToSFiltro( ToS alvo ) {
		this.alvo = alvo;
	}
	...
	public boolean filtrar( LibpcapLeitor pcap ) {
		...
		if( ! pcap.isIP() ) return false;
		
		ToS tos = pcap.getIP_ToS();
		
		return tos != null ? tos.equivale( alvo ) : false;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof IP_ToSFiltro ) ) return false;
		IP_ToSFiltro filtro = (IP_ToSFiltro) obj;
		return alvo.equals( filtro.alvo );
	}
	
	@Override
	public int hashCode() {
		return alvo.hashCode();
	}

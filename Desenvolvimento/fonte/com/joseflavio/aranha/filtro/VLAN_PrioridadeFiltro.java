 ...
 * @version 2011
 */
public class VLAN_PrioridadeFiltro implements Filtro {

	private int alvo;
	
	public VLAN_PrioridadeFiltro( int alvo ) {
		this.alvo = alvo;
	}
	...
	public boolean filtrar( LibpcapLeitor pcap ) {
		...
		return pcap.getVLAN_Prioridade() == alvo;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof VLAN_PrioridadeFiltro ) ) return false;
		VLAN_PrioridadeFiltro filtro = (VLAN_PrioridadeFiltro) obj;

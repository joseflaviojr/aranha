 ...
 * @version 2011
 */
public class MPLS_BitsFiltro implements Filtro {

	private int nivel;
	
	private int alvo;
	
	public MPLS_BitsFiltro( int nivel, int alvo ) {
		this.nivel = nivel;
		this.alvo = alvo;
	}
	...
	public boolean filtrar( LibpcapLeitor pcap ) {
		...
		return pcap.getMPLS_Bits( nivel ) == alvo;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof MPLS_BitsFiltro ) ) return false;
		MPLS_BitsFiltro filtro = (MPLS_BitsFiltro) obj;

 ...
 * @version 2011
 */
public class IP_TipoFiltro implements Filtro {

	private int alvo;
	
	public IP_TipoFiltro( int alvo ) {
		this.alvo = alvo;
	}
	...
	public boolean filtrar( LibpcapLeitor pcap ) {
		...
		return pcap.getIP_Tipo() == alvo;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof IP_TipoFiltro ) ) return false;
		IP_TipoFiltro filtro = (IP_TipoFiltro) obj;

 ...
 * @version 2011
 */
public class VLAN_CFIFiltro implements Filtro {

	private int alvo;
	
	public VLAN_CFIFiltro( int alvo ) {
		this.alvo = alvo;
	}
	...
	public boolean filtrar( LibpcapLeitor pcap ) {
		...
		return pcap.getVLAN_CFI() == alvo;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof VLAN_CFIFiltro ) ) return false;
		VLAN_CFIFiltro filtro = (VLAN_CFIFiltro) obj;

 ...
 * @version 2011
 */
public class Ethernet_TipoFiltro implements Filtro {

	private int alvo;
	
	public Ethernet_TipoFiltro( int alvo ) {
		this.alvo = alvo;
	}
	...
	public boolean filtrar( LibpcapLeitor pcap ) {
		...
		return pcap.getEthernet_Tipo() == alvo;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof Ethernet_TipoFiltro ) ) return false;
		Ethernet_TipoFiltro filtro = (Ethernet_TipoFiltro) obj;

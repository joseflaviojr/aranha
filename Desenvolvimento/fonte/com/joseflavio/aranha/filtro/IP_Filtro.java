 ...
 * @version 2011
 */
public class IP_Filtro implements Filtro {

	private IP alvo;
	
	private boolean origem;
	
	public IP_Filtro( IP alvo, boolean origem ) {
		this.alvo = alvo;
		this.origem = origem;
	}
	...
	public boolean filtrar( LibpcapLeitor pcap ) {
		...
		IP ip = origem ? pcap.getIP_Origem() : pcap.getIP_Destino();
		
		return ip != null ? ip.equivale( alvo ) : false;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof IP_Filtro ) ) return false;
		IP_Filtro filtro = (IP_Filtro) obj;

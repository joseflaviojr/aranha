 ...
 * @version 2011
 */
public class MPLS_TTLFiltro implements Filtro {

	private int nivel;
	
	private int alvo;
	
	public MPLS_TTLFiltro( int nivel, int alvo ) {
		this.nivel = nivel;
		this.alvo = alvo;
	}
	...
	public boolean filtrar( LibpcapLeitor pcap ) {
		...
		return pcap.getMPLS_TTL( nivel ) == alvo;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof MPLS_TTLFiltro ) ) return false;
		MPLS_TTLFiltro filtro = (MPLS_TTLFiltro) obj;

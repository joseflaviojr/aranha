 ...
 * @version 2011
 */
public class Ethernet_OrigemXDestinoFiltro implements Filtro {

	@Override
	public boolean filtrar( LibpcapLeitor pcap ) {
		
		return pcap.getEthernet_Origem().equals( pcap.getEthernet_Destino() );
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof Ethernet_OrigemXDestinoFiltro ) ) return false;
		return true;
	}

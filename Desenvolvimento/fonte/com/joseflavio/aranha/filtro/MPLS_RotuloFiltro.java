 ...
 * @version 2011
 */
public class MPLS_RotuloFiltro implements Filtro {

	private int nivel;
	
	private int alvo;
	
	public MPLS_RotuloFiltro( int nivel, int alvo ) {
		this.nivel = nivel;
		this.alvo = alvo;
	}
	...
	public boolean filtrar( LibpcapLeitor pcap ) {
		...
		return pcap.getMPLS_Rotulo( nivel ) == alvo;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof MPLS_RotuloFiltro ) ) return false;
		MPLS_RotuloFiltro filtro = (MPLS_RotuloFiltro) obj;
		return nivel == filtro.nivel && alvo == filtro.alvo;
	}

 ...
 * @version 2011
 */
public class IP_OrigemXDestinoFiltro implements Filtro {

	@Override
	public boolean filtrar( LibpcapLeitor pcap ) {
		
		return pcap.isIP() ? pcap.getIP_Origem().equals( pcap.getIP_Destino() ) : false;
		
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof IP_OrigemXDestinoFiltro ) ) return false;
		return true;
	}

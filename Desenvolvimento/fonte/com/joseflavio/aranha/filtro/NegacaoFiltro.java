...
/**
 * Nega outro {@link Filtro}.
 * @author José Flávio de Souza Dias Júnior
 * @version 2011
 */
public final class NegacaoFiltro implements Filtro {

	private Filtro filtro;
	
	public NegacaoFiltro( Filtro filtro ) {
		this.filtro = filtro;
	}

	@Override
	public boolean filtrar( LibpcapLeitor pcap ) {
		return ! filtro.filtrar( pcap );
	}
	
	@Override
	public boolean equals( Object obj ) {
		if( obj == null || !( obj instanceof NegacaoFiltro ) ) return false;
		NegacaoFiltro f = (NegacaoFiltro) obj;
		return filtro.equals( f.filtro );
	}
	
	@Override
	public int hashCode() {
		return filtro.hashCode() + 31;
	}

...
/**
 * Organiza os arquivos de captura existentes antes da execução do TCPDump.
 * @author José Flávio de Souza Dias Júnior
 * @version 2011
 */
public class PreTCPDump extends OrganizarTCPDump {
	...
	public static void main( String[] args ) {
		...
		PreTCPDump aplicacao = new PreTCPDump();
